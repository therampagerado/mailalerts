...
class MailAlerts extends Module
{
    ...
    public function renderList()
    {
        ...
        if ($productId) {
            ...
            $helper->currentIndex = Context::getContext()->link->getAdminLink('AdminOosProductNotifications', false);
    ...
    {
        $tabId = (int) Tab::getIdFromClassName('AdminOosProductNotifications');
        if ($tabId) {
            return true;
        }
